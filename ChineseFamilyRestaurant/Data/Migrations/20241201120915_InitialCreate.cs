    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Fresh and tender beef", "Beef" },
                    { 2, "Organic chicken", "Chicken" },
                    { 3, "Wild-caught fish", "Fish" },
                    { 4, "Soft flour tortilla", "Tortilla" },
                    { 5, "Crisp and fresh lettuce", "Lettuce" },
                    { 6, "Ripe and juicy tomatoes", "Tomato" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "A Delicious Chicken Taco", "Chicken Taco", 1.99m, 150 },
                    { 3, 2, "A Delicious Fish Taco", "Fish Taco", 3.99m, 300 }
                });
